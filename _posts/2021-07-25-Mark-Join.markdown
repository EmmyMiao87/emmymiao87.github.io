...
![MarkJoin公式.png](../img/MarkJoin公式.png)
...
![MarkJoinQueryPlan1.png](../img/MarkJoinQueryPlan1.png)

### step1：mark join 阶段
自底向上看，首先是对 orders 和 lineitem 这两张表进行了 Mark Join。也就是说对右表 lineitem 表进行 mark 操作。
![MarkJoinQueryPlan2.png](../img/MarkJoinQueryPlan2.png)
...
![Selection.png](../img/Selection.png)
...
![NullMarkJoin.png](../img/NullMarkJoin.png)
...
![markjoin公式2.png](../img/markjoin公式2.png)
